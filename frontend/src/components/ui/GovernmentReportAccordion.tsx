...
export function GovernmentReportAccordion({ disasterData }: { disasterData: any }) {
  const [isOpen, setIsOpen] = useState(false);

  if (!disasterData?.government_report) {
  ...
  return (
    <div className="border rounded-lg overflow-hidden">
      ...
      {isOpen && (
        <div
          className="prose max-w-none px-4 py-2 text-sm sm:text-base"
