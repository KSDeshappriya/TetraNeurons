...
import { 
  Building, Package, Heart, PhoneCall, Bus,
  MapPin, Clock, Phone, Info,
   User
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-4">
          {selectedCategory === 'all' ? 'All Resources Near Disaster' : `${resourceCategories.find(c => c.id === selectedCategory)?.label} Near Disaster`}
        </h2>
