...
TetraNeurons is a disaster management application with a React frontend, FastAPI backend, Firebase integration, and third-party API support.
...
<img src="./screenshots/mcp1.png" width="300" alt="MCP SERVER IN ACTION"/>
